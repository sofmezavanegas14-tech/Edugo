-- EduGo persistent community: Auth, profiles, posts, comments and likes.
-- Applied to Supabase project xdszveoxdrdnwwzzvkav on 2026-09-25.
-- Non-destructive: no existing application tables are dropped or recreated.
...
begin
  ...
  if not exists (
    ...
    where id = p_post_id and (privacy = 'public' or author_id = v_user_id)
